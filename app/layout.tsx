/**
 * Root Layout для Next.js каталога
 */
...
export const metadata: Metadata = {
  ...
  description: 'Интернет-магазин товаров для разработчиков: кофе, аксессуары, гаджеты и книги. Быстрая доставка, качественные товары.',
